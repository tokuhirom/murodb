...
All documentation (`docs-site/`, `README.md`, `docs/`) and code comments must be written in **English**. CLAUDE.md is the only exception (Japanese is allowed here for developer instructions).
